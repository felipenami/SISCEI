(function(angular) {
  ...
  angular.module('siscei')
	.controller('StudentController', function ($scope, $rootScope,$state, $importService, $mdDialog, $mdSidenav, $mdToast, $timeout, $window, $location, $locale , $q, $http) {
		 /**
...
//                .content('Não será possível recuperar este registro se for excluído.')
        ...
        $scope.listUsersByFilters = function(filters, pageRequest){
        	console.debug("test");
        	accountService.listStudentsByFilters( filters.terms.toString(), pageRequest, {
                callback: function (result) {
